...
//  TerminalColors
//
//  Created by Ulf Akerstedt-Inoue on 2023/11/15.
...
public enum ANSIStyle {
    ...
    public static func escape(fg: ExtendedColor?, bg: ExtendedColor? = nil, styles: [Style] = []) -> String {
